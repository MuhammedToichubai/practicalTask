...
import static com.company.gender.Gender.WOMAN;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User user = new User("Садыр ", 53, 1, MAN);
        User user1 = new User("Сооронбай", 60, 3, MAN);
        User user2 = new User("Роза", 57, 2, WOMAN);
        User user3 = new User("Акаев", 59, 5, MAN);
        ...
        userService.searchIDMn(mas, 1);
        System.out.println("----------------------------------------------------");
        userService.getAll(mas);
        System.out.println("----------------------------------------------------");
        userService.removeIDMn(mas, 2);
        userService.getAll(mas);
        System.out.println("----------------------------------------------------");
        userService.addUser(mas, new User("Almaz", 20, 4, MAN));
        userService.getAll(mas);
